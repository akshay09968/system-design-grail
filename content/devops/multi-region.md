...
**Next:** [Migrating Kubernetes across clouds](cluster-migration.md) — blue-green at cluster scale: the portability audit, the traffic layer above both clouds, and the interregnum you bound on purpose.
